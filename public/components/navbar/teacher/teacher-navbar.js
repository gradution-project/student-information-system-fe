                                ...
                                <Menu.Items
                                    ...
                                    <Menu.Item>
                                        {({active}) => (
                                            ...
                                            >
                                                {SisTeacherStorage.getFullName()}
                                                <p className="font-phenomenaLight text-center text-lg">{SisTeacherStorage.getNumber()}</p>
                                            </a>
                                        )}
                                    </Menu.Item>
                                    <Menu.Item>
                                        {({active}) => (
                                            <a href="/teacher/information/detail"
                                    ...
                                    <Menu.Item>
                                        {({active}) => (
                                            <a
                                                href="/"
                                                onClick={SisTeacherStorage.clearData}
