...
export async function getServerSideProps({query}) {
    ...
    const passwordOperationData = await TeacherPasswordOperationController.isPasswordChangeOperationEnabled(operationId);
    return {
        props: {
...
export default function TeacherChangePassword({isDataFound, operationId}) {
    ...
    const teacherForgotPassword = async (event) => {
        ...
        if (newPassword === newPasswordRepeat) {
            ...
            const apiResult = await TeacherPasswordOperationController.changePassword(operationId, newPassword, newPasswordRepeat);
